...
function showSkeleton(poseArray){
    ...
    if(poseArray.keypoints[0].score>0.8){// see the nose?
      ...
      if(poseArray.keypoints[10].score>0.0){//show right wrist if visible
        ellipse(poseArray.keypoints[10].position.x, poseArray.keypoints[10].position.y, 30, 'pink');//right wrist
      ...
      drawPosenet(cursorX,cursorY); // communicate to draw
    }
    else {
